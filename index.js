    ...
    const sendInitialSessionUpdate = () => {
      ...
      openAiWs.send(JSON.stringify({
        ...
        item: {
          ...
          content: [{
            type: 'input_text',
            text: `Bonjour, je suis Emilie de LeguichetPro. [petite pause] Est-ce que vous avez un instant ? [pause légère] Je souhaiterais vous parler du label Expert Pro, qui valorise les professionnels reconnus et vous donne accès à des services dédiés. [sourire dans la voix]`,
          }],
        },
      }));
